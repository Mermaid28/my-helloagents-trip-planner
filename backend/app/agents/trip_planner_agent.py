...
用户: "搜索上海的酒店"
你的回复: [TOOL_CALL:amap_maps_text_search:keywords=酒店,city=上海]
...
class MultiAgentTripPlanner:
    ...
    def _build_planner_query(self, request: TripRequest, attraction_response: str, weather_response: str, hotel_response: str):
        """构建行程规划查询"""
    ...
    def _parse_response(self, response: str, request: TripReuest) -> TripPlan:
        """解析Agent响应
